...
function fromSettingsRow(row: any): SiteSettings {
  return {
    ...
    introArtworkId: row.intro_artwork_id || "",
    ...
    featureArtworkId: row.feature_artwork_id || "",
